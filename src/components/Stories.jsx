                    ...
                    <SplideSlide key={i} className='mb-0.5'>
                        <div className='relative grid items-center gap-4 pb-2 rounded-lg shadow shadow-slate-200 ring-1 ring-slate-200'>
                            ...
                            <div className='flex items-center justify-center px-4 w-full'>
                                <a href={val.url} className='w-full bg-gradient-to-b from-slate-900 to-grey-900 to-black shadow-md shadow-black text-center text-slate-100 py-1.5 button-theme' target="_blank" role={"button"}>{val.btn}</a>
                            </div>
                        </div>
                    </SplideSlide>
                ))}
